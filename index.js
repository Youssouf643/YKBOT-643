...
const ownerNumber = ['237692323409']
...
console.log("Connecting YKBOT-643 🧬...");
...
wait conn.readMessages([mek.key])
}
...
//owner reacts==============
if(senderNumber.includes("237692323409")){
if(isReact) return
m.react("🦅")
}

if(senderNumber.includes("237659290023")){
if(isReact) return
m.react("😅")
}
//===============================================
...
app.get("/", (req, res) => {
res.send("hey, YKBOT-643 started✅");
});
